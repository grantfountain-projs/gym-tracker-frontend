...
import { createWorkout, getWorkoutStats } from '../api/workouts.js'
...
function Dashboard() {
    ...
    useEffect(() => {
        const fetchStats = async () => {
            try {
                const data = await getWorkoutStats(token);
                setStats(data);
            } catch (error) {
                console.error(error);
            }
    ...
    return (
        <div className="min-h-screen bg-black">
            ...
            <main className="flex flex-col items-center justify-center px-4 py-16">
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-3xl mb-32">
